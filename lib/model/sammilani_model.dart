...
class SammilaniModel {
  ...
  factory SammilaniModel.fromJson(String source) => SammilaniModel.fromMap(json.decode(source));

  @override
  String toString() => 'SammilaniModel(sammilaniNumber: $sammilaniNumber, sammilaniYear: $sammilaniYear, sammilaniPlace: $sammilaniPlace)';
  ...
  @override
  int get hashCode => sammilaniNumber.hashCode ^ sammilaniYear.hashCode ^ sammilaniPlace.hashCode;
}
