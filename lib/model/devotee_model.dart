...
class DevoteeModel {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (receivedBy != null) {
      result.addAll({'receivedBy': receivedBy});
    }
    if (updatedOn != null) {
